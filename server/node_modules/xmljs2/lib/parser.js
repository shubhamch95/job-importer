...
(function() {
  "use strict";
  var Promise, bom, defaults, events, isEmpty, processItem, processors, sax, setImmediate,
  ...
  exports.Parser = (function(superClass) {
    ...
    function Parser(opts) {
      ...
      this.setupCallback = bind(this.setupCallback, this);
    ...
    Parser.prototype.setupCallback = function(event, callbacks) {
      return this.on(event, (function(_this) {
        return function(result) {
          var cb, err, errToThrow, i, len;
          _this.reset();
          errToThrow = null;
    ...
    Parser.prototype.parseString = function(str, cb) {
      return new Promise((function(_this) {
        return function(resolve, reject) {
          ...
          _this.setupCallback("end", [
            resolve, function(r) {
              return cb(null, r);
            }
          ]);
          _this.setupCallback("error", [reject, cb]);
          try {
            str = str.toString();
            if (str.trim() === '') {
              _this.emit("end", null);
            ...
            if (_this.options.async) {
              _this.remaining = str;
              setImmediate(_this.processAsync);
              return _this.saxParser;
            }
            return _this.saxParser.write(str).close();
          } catch (error1) {
            err = error1;
            if (!(_this.saxParser.errThrown || _this.saxParser.ended)) {
              _this.emit('error', err);
              return _this.saxParser.errThrown = true;
            } else if (_this.saxParser.ended) {
              throw err;
            }
          }
        };
